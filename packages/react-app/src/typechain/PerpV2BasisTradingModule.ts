...
export type FeeStateStruct = {
  feeRecipient: string;
  maxPerformanceFeePercentage: BigNumberish;
  performanceFeePercentage: BigNumberish;
};

export type FeeStateStructOutput = [string, BigNumber, BigNumber] & {
  feeRecipient: string;
  maxPerformanceFeePercentage: BigNumber;
  performanceFeePercentage: BigNumber;
};

export interface PerpV2BasisTradingModuleInterface extends utils.Interface {
  functions: {
    ...
    "feeSettings(address)": FunctionFragment;
    ...
    "settledFunding(address)": FunctionFragment;
    "trade(address,address,int256,uint256)": FunctionFragment;
    "tradeAndTrackFunding(address,address,int256,uint256)": FunctionFragment;
    ...
    "updatePerformanceFee(address,uint256)": FunctionFragment;
    "withdraw(address,uint256)": FunctionFragment;
    "withdrawFundingAndAccrueFees(address,uint256)": FunctionFragment;
  };
  ...
  encodeFunctionData(functionFragment: "feeSettings", values: [string]): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "settledFunding",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "tradeAndTrackFunding",
    values: [string, string, BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "withdrawFundingAndAccrueFees",
    values: [string, BigNumberish]
  ): string;
  ...
  events: {
    ...
    "FundingWithdrawn(address,address,uint256,uint256,uint256)": EventFragment;
    "OwnershipTransferred(address,address)": EventFragment;
    "PerformanceFeeUpdated(address,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "FundingWithdrawn"): EventFragment;
...
export type FundingWithdrawnEvent = TypedEvent<
...
export type FundingWithdrawnEventFilter = TypedEventFilter<FundingWithdrawnEvent>;
...
export type PerformanceFeeUpdatedEvent = TypedEvent<
  [string, BigNumber],
  { _setToken: string; _newPerformanceFee: BigNumber }
>;

export type PerformanceFeeUpdatedEventFilter = TypedEventFilter<PerformanceFeeUpdatedEvent>;
...
export interface PerpV2BasisTradingModule extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpV2BasisTradingModuleInterface;
  ...
  settledFunding(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  filters: {
    ...
    "FundingWithdrawn(address,address,uint256,uint256,uint256)"(
      _setToken?: string | null,
      _collateralToken?: null,
      _amountWithdrawn?: null,
      _managerFee?: null,
      _protocolFee?: null
    ): FundingWithdrawnEventFilter;
    FundingWithdrawn(
      _setToken?: string | null,
      _collateralToken?: null,
      _amountWithdrawn?: null,
    ...
    "PerformanceFeeUpdated(address,uint256)"(
      _setToken?: string | null,
      _newPerformanceFee?: null
  ...
  estimateGas: {
    ...
    feeSettings(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
