...
export interface PerpV2LibraryV2Interface extends utils.Interface {
  functions: {
...
export interface PerpV2LibraryV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpV2LibraryV2Interface;
