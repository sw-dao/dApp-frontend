...
export interface AaveLeverageModuleInterface extends utils.Interface {
  functions: {
...
export type ReserveTokensUpdatedEvent = TypedEvent<
  [string, string, string],
  { _underlying: string; _aToken: string; _variableDebtToken: string }
>;

export type ReserveTokensUpdatedEventFilter = TypedEventFilter<ReserveTokensUpdatedEvent>;
...
export interface AaveLeverageModule extends BaseContract {
  ...
  filters: {
    ...
    "ReserveTokensUpdated(address,address,address)"(
      _underlying?: string | null,
      _aToken?: string | null,
      _variableDebtToken?: string | null
    ): ReserveTokensUpdatedEventFilter;
