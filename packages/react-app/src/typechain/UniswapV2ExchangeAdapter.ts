...
export interface UniswapV2ExchangeAdapterInterface extends utils.Interface {
  functions: {
...
export interface UniswapV2ExchangeAdapter extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UniswapV2ExchangeAdapterInterface;
