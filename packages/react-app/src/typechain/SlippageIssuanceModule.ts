...
export interface SlippageIssuanceModuleInterface extends utils.Interface {
  functions: {
    ...
    "getRequiredComponentIssuanceUnitsOffChain(address,uint256)": FunctionFragment;
    "getRequiredComponentRedemptionUnits(address,uint256)": FunctionFragment;
    "getRequiredComponentRedemptionUnitsOffChain(address,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getRequiredComponentIssuanceUnitsOffChain",
    values: [string, BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getRequiredComponentRedemptionUnitsOffChain",
    values: [string, BigNumberish]
  ): string;
  encodeFunctionData(
...
export type RedeemFeeUpdatedEventFilter = TypedEventFilter<RedeemFeeUpdatedEvent>;
...
export interface SlippageIssuanceModule extends BaseContract {
