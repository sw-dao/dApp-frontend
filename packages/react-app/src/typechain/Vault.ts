...
export type UpdateRewardsEvent = TypedEvent<[string], { rewards: string }>;
...
export type UpdateGuardianEvent = TypedEvent<[string], { guardian: string }>;
...
export type StrategyRevokedEvent = TypedEvent<[string], { strategy: string }>;
