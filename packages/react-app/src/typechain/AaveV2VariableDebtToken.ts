...
export interface AaveV2VariableDebtTokenInterface extends utils.Interface {
  functions: {
...
export interface AaveV2VariableDebtToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AaveV2VariableDebtTokenInterface;
