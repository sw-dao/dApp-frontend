...
export interface SetTokenAccessibleMockInterface extends utils.Interface {
  functions: {
    ...
    "testOnlyAllowedSet(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testOnlyAllowedSet",
    values: [string]
  ): string;
  encodeFunctionData(
...
export interface SetTokenAccessibleMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SetTokenAccessibleMockInterface;
