...
type PerpV2ClearingHouseConfigConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: PerpV2ClearingHouseConfigConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class PerpV2ClearingHouseConfig__factory extends ContractFactory {
  constructor(...args: PerpV2ClearingHouseConfigConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
