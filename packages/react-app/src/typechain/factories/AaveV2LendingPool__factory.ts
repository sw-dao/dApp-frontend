...
type AaveV2LendingPoolConstructorParams =
  | [linkLibraryAddresses: AaveV2LendingPoolLibraryAddresses, signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: AaveV2LendingPoolConstructorParams
...
export class AaveV2LendingPool__factory extends ContractFactory {
  constructor(...args: AaveV2LendingPoolConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
